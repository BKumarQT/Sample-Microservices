...
class ONSManagement:
    ...
    async def call_qth(self,qcl_data):
        ...
        # please do not add any '/' at the end of the url
        url = f"{config('MS3_HOST')}/qcl/accounting/crossconnect/qcl_crossconnect_order"
        requests.post(url, headers=headers, json=qcl_data)
